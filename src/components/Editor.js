...
import { insertEditorElement, moveEditorElement } from "../utils/globalSlice";
    ...
    <>
      ...
      <div className="flex flex-col flex-1 gap-4 w-full min-w-[20rem]">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl">Drag-N-Drop Form Builder</h1>
          <button
        ...
        >
          {editorElements.length < 1 && (
            <div className="text-center p-10 border-2 border-dashed border-slate-400 rounded-md">
              <h1 className="text-xl text-slate-500">Drop Here!</h1>
            </div>
          )}
